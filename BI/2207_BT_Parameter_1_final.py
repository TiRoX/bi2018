...
# Quelle -> https://github.com/Microsoft/LightGBM/blob/master/tests/python_package_test/test_sklearn.py
    ...
    clf = lightgbm.LGBMClassifier(boosting_type='gbdt', num_leaves=31, max_depth=-1, learning_rate=0.1,min_child_samples=20, n_estimators=120,subsample_for_bin=200000,  objective='multiclass', silent=False )
...
# MLL bei 2.36943 nach 103. Iteration. Danach Anstieg.     
