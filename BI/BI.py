...
def readF(var):
    ...
    output = read_csv(var, delimiter= ',', header = 0, dtype={"Dates": str,  "Descript": str, "DayOfWeek": str, "PdDistrict": str, "Resolution": str, "Address": str, "X": str, "Y": str}) # type = pandas.core.frame.DataFrame
    ...
    with pa.option_context('display.max_rows', 11, 'display.max_columns', 200):
        ...
        #print(output[['Date', 'Time', 'Category', 'Descript', 'DayOfWeek', 'PdDistrict', 'Resolution', 'Address','X','Y' ]])
